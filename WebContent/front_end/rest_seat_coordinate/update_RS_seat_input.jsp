...
%>
<%=rest_Seat_Coordinate_TableVO.getRs_id()==null %>
<html>
<head>
<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
<title>餐廳座標資料修改 - update_RS_seat_input.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>餐廳座標資料修改 - update_RS_seat_input.jsp</h3>
...
<table>
	...
	<tr>
		<td>餐廳座位座標:</td>
		<td><input type="TEXT" name="rs_seat_xy" size="45" value="<%=rest_Seat_Coordinate_TableVO.getRs_seat_xy()%>" /></td>
	</tr>
	<tr>
		<td>座位加入時間:</td>
...
<input type="hidden" name="rs_seat_sieral" value="<%=rest_Seat_Coordinate_TableVO.getRs_seat_sieral()%>">
...
//  	       step: 1,                //step: 60 (這是timepicker的預設間隔60分鐘)
 		   ...
 		   value: '<%=rest_Seat_Coordinate_TableVO.getRs_seat_xy_time()%>', // value:   new Date(),
