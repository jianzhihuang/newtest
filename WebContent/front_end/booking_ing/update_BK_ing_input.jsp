...
<table>
	...
	<tr>
		<td>餐廳座位狀態:</td>
		<td><input type="TEXT" name=rs_status size="45" value="<%=booking_Ing_TableVO.getRs_status()%>" /></td>
	</tr>
...
<input type="hidden" name="order_id" value="<%=booking_Ing_TableVO.getOrder_id()%>">
