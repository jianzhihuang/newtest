...
<title>餐廳公版資料新增 - addEmp.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>餐廳公版資料新增 - addEmp.jsp</h3></td><td>
		 <h4><a href="<%=request.getContextPath()%>/front_end/booking_fixed/select_page.jsp"><img src="images/tomcat.png" width="100" height="100" border="0">回首頁</a></h4>
	</td></tr>
</table>
