...
<%
Booking_Fixed_TableVO booking_Fixed_TableVO = (Booking_Fixed_TableVO) request.getAttribute("booking_Fixed_TableVO"); //EmpServlet.java (Concroller) 存入req的empVO物件 (包括幫忙取出的empVO, 也包括輸入資料錯誤時的empVO物件)
%>
...
<table id="table-1">
	<tr><td>
		 <h3>餐廳公版資料修改 - update_emp_input.jsp</h3>
...
<table>
	...
	<tr>
		<td>餐廳桌號:</td>
		<td><input type="TEXT" name="rs_table_number" size="45" value="<%=booking_Fixed_TableVO.getRs_table_number()%>" /></td>
	</tr>
	<tr>
		<td>餐廳人數:</td>
		<td><input type="TEXT" name="rs_table_seat" size="45"	value="<%=booking_Fixed_TableVO.getRs_table_seat()%>" /></td>
	</tr>
<jsp:useBean id="rest_Seat_CoordinateSvc" scope="page" class="com.rest_seat_coordinate.model.Rest_Seat_Coordinate_TableService" />
	<tr>
		<td>餐廳座位編號:<font color=red><b>*</b></font></td>
...
<input type="hidden" name="rs_sieral" value="<%=booking_Fixed_TableVO.getRs_sieral()%>">
